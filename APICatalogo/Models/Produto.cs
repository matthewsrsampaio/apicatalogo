...
namespace ApiCatalogo.Models
{
    ...
    public class Produto : IValidatableObject
    {
        ...
        public string? Nome { get; set; }                 //[StringLength(20, MinimumLength = 3, ErrorMessage = "O nome deve ter entre {2} e {1} caracteres.")]                                                   //[PrimeiraLetraMaiuscula] 
                                                          //Criamos essa anotação que verifica se a primeira letra do nome inserido é maiúscula

        [Required]                              //especifica que o valor do campo é NOTNULL
        public string? Descricao { get; set; }  //[StringLength(80, ErrorMessage = "A descrição deve ter no máximo entre {1} caracteres.")]
